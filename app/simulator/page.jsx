...
export const metadata = { title: "Match simulator" };
  ...
  return (
    <div className="space-y-7">
      <PageIntro
        ...
        actions={<span className="chip"><FlaskConical className="size-3.5 text-accent" /> Scenario analysis</span>}
      />
      <PredictionLab />
      <div className="surface-flat flex items-start gap-3 p-5 text-xs leading-5 text-ink-muted"><BrainCircuit className="mt-0.5 size-4 shrink-0 text-brand-strong" /><p>Manual simulations explore a hypothetical matchup. Automatic forecasts are the auditable predictions that enter the live model scorecard before kickoff.</p></div>
    </div>
  );
}
